/**
 * @brief Measurements using the binary serializer from the library on
 * big arrays and vectors.
...
time taken for execution: 0.37 s
...
int main()
{
  ofstream os("bigfile_binary");
  BinaryStreamWriter w(os);
