 ...
 * arrays, and vectors.
 * 
 * This uses the binary version of the serializer.
 *
 * Size of output file: 163 bytes
 */
...
int main()
{
  ...
  ofstream stream("serialized_class_binary.bin");
  ...
  ifstream readstream("serialized_class_binary.bin");
